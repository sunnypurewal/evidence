...
This folder contains public launch materials for `evidence`.

- [`introducing-evidence.md`](introducing-evidence.md): long-form launch blog draft.
- [`devto-cross-post.md`](devto-cross-post.md): dev.to adaptation with Swift/iOS framing.
